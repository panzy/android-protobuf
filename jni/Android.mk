...
LOCAL_C_INCLUDES := \
    ...
    $(LOCAL_PATH) \
    $(JNI_H_INCLUDE)
$(call __ndk_info, JNI_H_INCLUDE=$(JNI_H_INCLUDE))
$(call __ndk_info, LOCAL_C_INCLUDES=$(LOCAL_C_INCLUDES))
...
LOCAL_CFLAGS := -DGOOGLE_PROTOBUF_NO_RTTI -DHAVE_PTHREAD 
	# -DHAVE_HASH_MAP -DHAVE_HASH_SET
